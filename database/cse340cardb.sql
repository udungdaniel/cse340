...
ALTER TYPE public.account_type OWNER TO cse340cardb_v47e_user;
...
--Query 5. Inner join to get make, model, and classification_name for inventory items in the 'Sport' category
SELECT i.inv_make,
	i.inv_model,
...
-- Query 6. Update all records to add "/vehicles" to the middle of inv_image and inv_thumbnail paths
UPDATE public.inventory
